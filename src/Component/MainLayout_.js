...
import MyCharity from "./MyCharityPage.js"
...
class MainLayout extends React.Component
{
    constructor(props)
    {
      ...
      this.myCharity = this.myCharity.bind(this);
       ...
       <Layout>
        ...
        <div style={{marginLeft:'-50px',width:(window.innerWidth),background:'white'}}>
            <img src="img/mdHeader.png" style={{width: window.innerWidth ,height: '70px',top: '0px',left: '0px'}}/>
              ...
              <a  style={{textDecoration:'underline',position: 'relative', top: '-57px', color:'#FFFFFF',right:'-1033px'}} onClick={this.myCharity.bind(this,"myCharity")}><Router><Link >My Charity</Link></Router></a>
